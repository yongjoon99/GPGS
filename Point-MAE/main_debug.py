...
def main():
    ...
    config.dataset.train._base_.infer = args.infer
    config.dataset.train._base_.center_coord = os.path.abspath(f'../output/{args.dataset}/{args.scene}/center_coord.npy')
    config.dataset.train._base_.DATA_PATH = os.path.abspath(f'../data/{args.dataset}/{args.scene}')
    config.dataset.train._base_.PC_PATH = os.path.abspath(f'../data/{args.scene}' )
    # run
